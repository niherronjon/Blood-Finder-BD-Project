...
function loadProfile() {
    ...
    if (data) {
        ...
        document.getElementById("lastDonationDate").value = data.lastDonation || "";
        document.getElementById("availabilityStatus").checked = data.available || false;
    }
}
...
document.getElementById("profileForm").addEventListener("submit", function (e) {
    ...
    const userData = {
        ...
        available: document.getElementById("availabilityStatus").checked
    };
...
// Call this when analytics section opens
...
function loadSummary() {
    ...
    document.getElementById("analyticsDonors").innerText = donors.length;
    document.getElementById("analyticsRequests").innerText = requests.length;

    document.getElementById("analyticsDonations").innerText = donors.length * 2;
    document.getElementById("analyticsLives").innerText = donors.length * 3;
}
